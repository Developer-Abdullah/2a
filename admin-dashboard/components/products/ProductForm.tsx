...
export default function ProductForm({ product }: { product?: Product }) {
  ...
  const label = "text-sm font-medium text-foreground/80";
  const field = "flex w-full rounded-md border border-input bg-card px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
